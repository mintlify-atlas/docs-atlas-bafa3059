...
<CardGroup cols={2}>
  <Card title="Process APIs" icon="microchip" href="/api/process/enum-processes">
    Enumerate, find, and manage processes on the system
  </Card>
  
  <Card title="Thread APIs" icon="timeline" href="/api/thread/enum-threads">
    Enumerate and retrieve information about process threads
  </Card>
  
  <Card title="Module APIs" icon="cube" href="/api/module/enum-modules">
    Load, unload, find, and enumerate modules in processes
  </Card>
  
  <Card title="Symbol APIs" icon="code" href="/api/symbol/enum-symbols">
    Find and enumerate symbols in modules with demangling support
  </Card>
  
  <Card title="Memory Segment APIs" icon="layer-group" href="/api/segment/enum-segments">
    Enumerate and find memory segments in process address space
  </Card>
  
  <Card title="Memory APIs" icon="memory" href="/api/memory/read-write">
    Read, write, allocate, protect, and manage memory
  </Card>
  
  <Card title="Scanning APIs" icon="magnifying-glass" href="/api/scanning/deep-pointer">
    Search memory for patterns, signatures, and data
  </Card>
  
  <Card title="Assembler APIs" icon="wrench" href="/api/assembler/assemble">
    Assemble and disassemble instructions for multiple architectures
  </Card>
  
  <Card title="Hooking APIs" icon="link" href="/api/hooking/hook-code">
